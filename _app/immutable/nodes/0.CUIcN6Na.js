  ...
  (a = new zt({ props: { text: "Become A Part Of Nfinity" } })),
    ($ = new X({
      props: {
        ...
        href: "https://t.me/official_nfinityAI",
        className:
    ...
    (E = new X({
      props: {
        text: "Buy on Uniswap",
        variant: "textGradient",
        href: "https://app.uniswap.org/explore/tokens/ethereum/0x82d36570842fc1ac2a3b4dbe0e7c5c0e2e665090",
        className:
          "font-avantGarde text-[1.125rem] font-bold h-[3.6875rem] w-[12.5rem] md:w-full",
      },
    }));
