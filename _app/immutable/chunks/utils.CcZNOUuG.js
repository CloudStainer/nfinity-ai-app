function Le(e, r) {
  ...
  for (; n--; ) {
    const l = e[n],
      s = r[n];
    if (s) {
      for (const c in l) c in s || (o[c] = 1);
      for (const c in s) i[c] || ((t[c] = s[c]), (i[c] = 1));
      e[n] = s;
    } else for (const c in l) i[c] = 1;
  }
  for (const l in o) l in t || (t[l] = void 0);
  return t;
}
function _e(e) {
...
const B = "-",
  ...
  Y = (e, r) => {
    ...
    const n = e.join(B);
    return (l = r.validators.find(({ validator: s }) => s(n))) == null
      ? void 0
      : l.classGroupId;
  },
  K = /^\[(.+)\]$/,
  ...
  ie = (e) => {
    ...
    return (
      ae(Object.entries(e.classGroups), t).forEach(([n, l]) => {
        O(l, o, n, r);
      }),
      o
    );
      ...
      ? e.map(([t, o]) => {
          const i = o.map((n) =>
            typeof n == "string"
              ...
              : typeof n == "object"
              ? Object.fromEntries(
                  Object.entries(n).map(([l, s]) => [r + l, s])
                )
              : n
          );
          return [t, i];
  ...
  ce = (e) => {
    ...
    return {
      get(n) {
        ...
        if ((l = o.get(n)) !== void 0) return i(n, l), l;
      },
      set(n, l) {
    ...
    const { separator: r, experimentalParseClassName: t } = e,
      ...
      l = (s) => {
        ...
        for (let u = 0; u < s.length; u++) {
          let f = s[u];
          if (g === 0) {
            if (f === i && (o || s.slice(u, u + n) === r)) {
              c.push(s.slice(m, u)), (m = u + n);
              continue;
            }
            if (f === "/") {
              y = u;
        ...
        const x = c.length === 0 ? s : s.substring(m),
          v = x.startsWith(D),
          w = v ? x.substring(1) : x,
          b = y && y > m ? y - m : void 0;
        return {
...
function me(e, ...r) {
  ...
  function l(c) {
    ...
    return (t = ue(g)), (o = t.cache.get), (i = t.cache.set), (n = s), s(c);
  }
  function s(c) {
    const g = o(c);
    if (g) return g;
...
const d = (e) => {
  ...
  Ne = () => {
    const e = d("colors"),
      ...
      w = d("gradientColorStopPositions"),
      b = d("inset"),
      u = d("margin"),
      f = d("opacity"),
      h = d("padding"),
    ...
    return {
      ...
      classGroups: {
        ...
        grow: [{ grow: I() }],
        shrink: [{ shrink: I() }],
        order: [{ order: ["first", "last", "none", P, a] }],
        "grid-cols": [{ "grid-cols": [j] }],
        "col-start-end": [{ col: ["auto", { span: ["full", P, a] }, a] }],
        "col-start": [{ "col-start": N() }],
        "col-end": [{ "col-end": N() }],
        "grid-rows": [{ "grid-rows": [j] }],
        "row-start-end": [{ row: ["auto", { span: [P, a] }, a] }],
        ...
        "underline-offset": [{ "underline-offset": ["auto", C, a] }],
        ...
        "outline-offset": [{ "outline-offset": [C, a] }],
        ...
        contrast: [{ contrast: [c] }],
        "drop-shadow": [{ "drop-shadow": ["", "none", S, a] }],
...
function Ve() {
  ...
  e.appendChild(r);
  const t = e.offsetWidth - r.offsetWidth;
  return e.parentNode.removeChild(e), t;
}
export { _e as a, Ve as b, $e as c, Le as g };
