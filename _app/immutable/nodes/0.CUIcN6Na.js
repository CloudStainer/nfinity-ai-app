...
function sl(r) {
  ...
  return (
    (t = new Ee({ props: { items: Dt, title: "Starting with Solis" } })),
    (n = new Ee({
      props: { items: r[2], title: "SOLIS MODELS", titleLink: "/" },
    })),
...
function ol(r) {
  let e,
    ...
    V;
  (a = new zt({ props: { text: "Become A Part Of Solis" } })),
    ($ = new X({
      props: {
    ...
    (E = new X({
      props: {
        text: "Buy on Uniswap",
        variant: "textGradient",
        href: "https://app.uniswap.org/explore/tokens/ethereum/0x0000000000000000000000000000000",
        className:
          "font-avantGarde text-[1.125rem] font-bold h-[3.6875rem] w-[12.5rem] md:w-full",
      },
    }));
...
function $t(r) {
  ...
  return (
    (t = M(r)),
    (l = _[t] = h[t](r)),
    (n = new Ee({ props: { items: Dt, title: "Starting with Solis" } })),
    (d = new Ee({
      props: { items: r[7], title: "SOLIS MODELS", titleLink: "/" },
    })),
  ...
  return (
    (y = new X({
      props: {
        ...
        href: "https://app.uniswap.org/explore/tokens/ethereum/0x00000000000000000000000000",
      },
    })),
    {
      c() {
