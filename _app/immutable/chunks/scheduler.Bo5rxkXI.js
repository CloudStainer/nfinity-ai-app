...
function gt(t, e) {
  return t === e
    ? !0
    : (p || (p = document.createElement("a")), (p.href = e), t === p.href);
}
function bt(t) {
    ...
    const a = e[c].claim_order,
      u =
        (s > 0 && e[n[s]].claim_order <= a
          ? s + 1
          : V(1, s, (I) => e[n[I]].claim_order, a)) - 1;
    i[c] = n[u] + 1;
    const j = u + 1;
    (n[j] = c), (s = Math.max(j, s));
  }
  const o = [],
    r = [];
  let l = e.length - 1;
...
function _t() {
  ...
  do {
    ...
    for (v(null), m.length = 0, _ = 0; L.length; ) L.pop()();
